...
y -= 15
y = draw_text(c, y, "We built and tested this", size=22)
y = draw_text(c, y, "on Solana smart contracts.", size=22)
y = draw_text(c, y, "The core logic works.", size=22)
y = draw_text(c, y, "But production deployment needs", size=22)
y = draw_text(c, y, "security audits and", size=22)
y = draw_text(c, y, "hardened engineering.", size=22)
y = draw_text(c, y, "That's what funding is for.", size=24, bold=True)
y -= 10
y = draw_text(c, y, "What you see here:", size=22)
y = draw_text(c, y, "twelve cards, real oracle sources,", size=22)
y = draw_text(c, y, "working pricing engine,", size=22)
y = draw_text(c, y, "full consumer frontend.", size=22)
y = draw_text(c, y, "We build fast.", size=24, bold=True)
y -= 25
